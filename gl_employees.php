            ...
            <div class="table-container">
                ...
                <form id="bulkDeleteForm" method="POST" action="">
                    ...
                    <table>
                        ...
                        $query = "SELECT * FROM employees WHERE role IN ('employee', 'qa', 'intern')";
                        $where_clauses = [];
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td style='color: #64748b;'>" . htmlspecialchars($row['role']) . "</td>";
                            ...
                            echo "<tr><td colspan='10'><div class='empty-state'><div class='empty-state-icon'>📋</div><div class='empty-state-text'>No employees found.</div></div></td></tr>";
                        }
                        ?>
                        </tbody>
                    </table>
