...
$present_count = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as cnt FROM attendance_logs WHERE emp_id = '$current_employee_id' AND MONTH(date) = $selected_month AND YEAR(date) = $selected_year AND status IN ('P', 'LATE', 'EARLY')"))['cnt'];
...
$early_count = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as cnt FROM attendance_logs WHERE emp_id = '$current_employee_id' AND MONTH(date) = $selected_month AND YEAR(date) = $selected_year AND status = 'EARLY'"))['cnt'];
    ...
    <main class="main-content">
        ...
        <div class="content">
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-title">Late / Early Leave</div>
