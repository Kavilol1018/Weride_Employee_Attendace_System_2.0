                ...
                <tbody>
                    <?php if(mysqli_num_rows($report_result) > 0): ?>
                        <?php while($row = mysqli_fetch_assoc($report_result)): 
                            $avg_hours = $row['days_worked'] > 0 ? $row['total_hours'] / $row['days_worked'] : 0;
                        ?>
                        <tr>
                            ...
                            <td><strong><?= $row['days_worked'] ?></strong></td>
                            <td>
                                <?php if($avg_hours < 7): ?>
                                    <span class="badge badge-low"><?= number_format($avg_hours, 1) ?>h</span>
                                <?php else: ?>
                                    <span class="badge badge-high"><?= number_format($avg_hours, 1) ?>h</span>
                                <?php endif; ?>
                            </td>
                            <td style="font-size: 16px; font-weight: 700; color: #3b82f6;">
                                <?= number_format($row['total_hours'], 1) ?> hrs
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
