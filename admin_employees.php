                ...
                <form id="bulkDeleteForm" method="POST" action="">
                    ...
                    <table>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                                ...
                                echo "<td class='actions-cell'>
                                    <div class='dropdown'>
                                        ...
                                        <div class='dropdown-content'>
                                            <button type='button' onclick='openDetailsModal(\"" . htmlspecialchars($row['emp_id']) . "\", \"" . htmlspecialchars(addslashes($row['name'])) . "\", \"" . htmlspecialchars($row['employment_type']) . "\", \"" . htmlspecialchars($row['onboarding_date'] ?? '-') . "\", " . ($row['annual_leave_balance'] ?? 8) . ", " . ($row['sick_leave_balance'] ?? 14) . ", \"" . htmlspecialchars($row['role'] ?? '') . "\", \"" . htmlspecialchars($row['lunch_window'] ?? '') . "\", \"" . htmlspecialchars($row['shift_hour'] ?? '09:00-18:00') . "\")'>ℹ️ Details</button>
                            ...
                            echo "<tr><td colspan='7' style='text-align: center; padding: 20px; color: #64748b;'>No employees found</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
